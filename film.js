...
const selectedFilm = filmy.find((film) => film.id === identifikator);
console.log(selectedFilm);

const elementFilm = document.querySelector('#detail-filmu');
		...
		<div class="row g-0">
			<div class="col-md-5">
				<img
					...
					width="${selectedFilm.sirka}"
					height="${selectedFilm.vyska}"
				/>
			</div>
			<div class="col-md-7">
				<div class="card-body">
					<h5 class="card-title">${selectedFilm.nazev}</h5>
					<p class="card-text">${selectedFilm.popis}</p>
					<p class="card-text">
						<small class="text-muted" id="premiera"
							>${selectedFilm.premiera}</small
						>
					</p>
					<h6>Hodnocení</h6>
					<div class="stars">
